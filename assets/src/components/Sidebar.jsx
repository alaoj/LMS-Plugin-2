import { Award, Bell, BookOpen, Bot, Building2, ClipboardCheck, CreditCard, LayoutDashboard, Settings, UserRoundPlus, Users } from 'lucide-react';
...
const items = [
  ...
  { label: 'Groups', icon: UserRoundPlus, view: 'groups' },
